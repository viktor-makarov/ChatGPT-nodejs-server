        ...
        this.#buildInAgents = [
            ...
            },
            {
                ...
                tools: [
                    ...
                    "fn_get_knowledge_base_item",
                    "fn_extract_content",
                    "fn_insert_grocery_data",
                    "fn_fetch_url_content",
                    "fn_generate_document",
                    "fn_save_to_document",
                    "fn_currency_converter",
                    "fn_receipt_details_categoriser",
                    "fn_get_currency_rates",
                ],
                memory: [],
                system_prompt: devPrompts.receipts_parser_start(`\`${process.env.BIGQUERY_PROJECT_ID}.${process.env.GROCERY_DATASET}.${process.env.GROCERY_TABLE}\``),
                include_current_time: true,
                availableForUserGroups: ["admin", "basic"],
                properties: {
                    model_mode: "clever",
