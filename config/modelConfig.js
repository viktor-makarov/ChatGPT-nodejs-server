...
"o3":{
    ...
    "long_wait_notes": [
        ...
        {time_ms:60000,comment:"Кажется, наш сервер пошел пить кофе... Может и Вам выпить чашечку, пока ждете?☕️"},
        {time_ms:75000,comment:"Вы все еще здесь? Отлично! Мы продолжаем работу над вашим запросом и ценим Ваше терпение."},
        {time_ms:90000,comment:"К сожалению, запрос не может быть выполнен сейчас, просим прощения и предлагаем попробовать позже."}
    ],
},
"o3-mini":{
