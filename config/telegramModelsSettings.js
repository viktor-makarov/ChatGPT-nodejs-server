module.exports = {
    ...
    "texttospeech":{
        "welcome_msg":"Функция Текст в голос может преобразовать текст в аудио запись. Пришлите текст, который нужно преобразовать. Длина текста не должна превышать [limit] символов. Текущий голос = [voice], текущая модель = [model].",
        "name":"Текст в голос",
        "hostname":'https://api.openai.com',
