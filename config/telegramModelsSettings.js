module.exports = {
    ...
    "texttospeech":{
        "welcome_msg":"Функция Текст в голос может преобразовать текст в аудио запись. Пришлите текст, который нужно преобразовать. Длина текста не должна превышать [limit] символов.",
        "name":"Текст в голос",
        "hostname":'https://api.openai.com',
