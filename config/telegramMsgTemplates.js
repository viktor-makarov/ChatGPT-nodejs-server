module.exports = {
    ...
    "unregistered":"Окей! Ваша регистрация прекращена и данные удалены. Теперь каждый сам по себе... ) Шутка! Надеюсь, еще увидимся! )",
    ...
    "error_api_other_problems": "Ошибка стороннего сервиса.  Обратитесь в администратору.",
    ...
    "OAI_ERR1":"Ошибка стороннего сервиса. Сервис временно недоступен. Попробуйте повторить запрос позже.",
