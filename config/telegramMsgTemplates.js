module.exports = {
    ...
    "no_profile_yet":"К сожалению, Ваша учетная запись не найдена. Чтобы зарегистрироваться, пришлите команду /start.",
    "profile_deactivated":"К сожалению, Ваша учетная запись деактивирована. Пожалуйста, обратитесь к администратору https://t.me/Truvoruwka",
    ...
    "mdj_lacks_prompt":"Промпт не найден. Добавьте промт в следующем формате: /imagine <промпт>.",
