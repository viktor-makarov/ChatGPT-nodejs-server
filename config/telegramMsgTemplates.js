module.exports = {
    ...
    "function_request_msg_short":"Выполнется функция [function] ([number])",
    "function_request_msg_full":"Выполнется функция [function] ([number]) [request]",
    "function_end_unsuccessful_short":">> Функции [function] ([number]) завршилась ошибкой.",
    "function_end_unsuccessful_full":">> Функции [function] ([number]) завршилась ошибкой. \n [result]",
    "function_end_successful_short":"Функция [function] ([number]) выполнена успешно за [time] сек..",
    "function_end_successful_full":"Функция [function] ([number]) выполнена успешно за [time] сек. [result]",
