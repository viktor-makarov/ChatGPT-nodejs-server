module.exports = {
    ...
    "error_api_too_many_req":"Ошибка сервиса OpenAI. Превышен лимит обращений в минуту. Повторите запрос позже.",
    ...
    "OAI_ERR1":"Сервис OpenAI временно недоступен. Попробуйте еще раз или повторите запрос позже.",
    ...
    "function_request_status_msg2":"...",
    "function_request_msg":"Запрошено выполнение функции: [function]",
    "function_end":"Запрошено выполнение функции: [function]",
    ...
    "timeout_messages":["Ответа все нет… Давайте еще подождем…","Прошло 30 сек., а ответа от OpenAI все нет... Cтранно … Но подождем еще немного …","… уже 45 секунд. Такое бывает очень редко. Возможно, с сервером что-то не так. Но дадим ему шанс …","… 60 секунд… Это у же совсем никуда не годится. Ждем еще 30 секунд и вырубаем запрос…"],
