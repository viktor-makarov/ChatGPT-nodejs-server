module.exports = {
    ...
    "image_size_exceeded": {
        "en":"Unfortunately, there are too many images in this conversation. Their total size ([actualsize]) has exceeded the limit of [limit]. The conversation will have to be forcibly restarted.😔",
        "ru":"К сожалению, в этом диалоге стало слишком много картинок. Их общий объем ([actualsize]) превысил лимит [limit]. Диалог придется принудительно перезапустить.😔"
        },
